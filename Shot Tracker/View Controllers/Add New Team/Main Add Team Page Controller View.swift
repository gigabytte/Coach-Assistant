//
//  Main Add Team Page Controller View.swift
//  Shot Tracker
//
...
class Main_Add_Team_Page_Controller_View: UIPageViewController {

    weak var tutorialDelegate: AddTeamPageViewControllerDelegate?
    
    private(set) lazy var orderedViewControllers: [UIViewController] = {
        // The view controllers will be shown in this order
        return [self.newViewController("Add_New_Team_Popup_View_Controller"),
                self.newViewController("Add_Team_Copy_Players_View_Controller")]
    }()
...
extension Main_Add_Team_Page_Controller_View: UIPageViewControllerDataSource {
...
extension Main_Add_Team_Page_Controller_View: UIPageViewControllerDelegate {
...
protocol AddTeamPageViewControllerDelegate: class {
    
    
    
    func tutorialPageViewController(tutorialPageViewController: Main_Add_Team_Page_Controller_View,
